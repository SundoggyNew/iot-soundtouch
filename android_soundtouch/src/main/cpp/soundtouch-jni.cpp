...
Java_com_iot_soundtouch_interfaces_SoundTouch_clearBytes(JNIEnv *env, jclass clazz, jint track)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_com_iot_soundtouch_interfaces_SoundTouch_setup(JNIEnv *env, jclass clazz, jint track,
                                                    jint channels, jint samplingRate,
                                                    jint bytesPerSample, jfloat tempo,
                                                    jint pitchSemi)
                                                    {
    SoundTouchExt& soundTouch = sProcessors.at(track);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_iot_soundtouch_interfaces_SoundTouch_finish(JNIEnv *env, jclass clazz, jint track,
                                                     jint length)
                                                     {
    SoundTouchExt& soundTouch = sProcessors.at(track);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_iot_soundtouch_interfaces_SoundTouch_putBytes(JNIEnv *env, jclass clazz, jint track,
...
Java_com_iot_soundtouch_interfaces_SoundTouch_getBytes(JNIEnv *env, jclass clazz, jint track,
                                                       jbyteArray get, jint toGet)
                                                       {
    queue<signed char>* fBufferOut = sProcessors.at(track).fBufferOut;
